...
pastEnergy['value'] = -contractControllers.getDemandEnergy()
...
while True:
    ...
    if(newEnergy['time'] != pastEnergy['time']):
        ...
        case = usersControllers.updateEnergy(
        newEnergy['value'], pastEnergy['value'])
        usersControllers.transaction(
        web3.eth.defaultAccount, case, newEnergy['value'])
